...
def _run_backtest(b15, symbol, sh, eh, total_bars):
    """analyzer_v5.py:258-305 cagiri siracisi (birebir)."""
...
def _compare(symbol, b15, sh, eh):
    total_bars = len(b15)
    bt = _run_backtest(b15, symbol, sh, eh, total_bars)
    lv = _run_live(b15, symbol, sh, eh, total_bars)
